package com.prototype.murakumo.api
...
object MurakumoService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The murakumo service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the MurakumoService.
  */
trait MurakumoService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("murakumo")
      ...
      .withTopics(
        topic(MurakumoService.TOPIC_NAME, greetingsTopic _)
